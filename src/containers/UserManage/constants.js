...
export const GET_USER_INFO = `${FATCH_ACTION_PREFIX}GET_USER_INFO_${NAMESPACE}`;

export const GET_LOGIN_USER_INFO = `${FATCH_ACTION_PREFIX}GET_LOGIN_USER_INFO_${NAMESPACE}`;

export const GET_FULL_AUTH_AND_AUTHGROUP = `${FATCH_ACTION_PREFIX}GET_FULL_AUTH_AND_AUTHGROUP_${NAMESPACE}`;
...
export const UPDATE_AUTH_MODAL = `UPDATE_AUTH_MODAL_${NAMESPACE}`;
